...
import {
  ...
  Wrench, Clock, ShoppingCart, AlertTriangle, Check, ChevronRight,
...
const initialTodos: TodoItem[] = [
  {
    ...
    hasPhoto: true,
    status: "needs-parts",
    parts: "Broan 688 Fan Motor",
    partStatus: "Needs Purchase",
    specialist: false,
    notes: "Rattling sound, intermittent power",
  },
  {
    id: "2",
  ...
  {
    id: "4",
    task: "Replace garage door weatherstrip",
    priority: "low",
    hasPhoto: false,
    status: "confirmed",
    parts: null,
  ...
  },
  {
    ...
    partStatus: null,
    specialist: true,
    notes: "Breaker trips on circuit 4 — licensed electrician needed",
  },
];
...
const completedVisits = [
  {
    date: "Mar 15, 2026",
    tech: "Anthony",
    tasks: ["Replaced kitchen faucet", "Fixed garbage disposal", "Caulked kitchen sink"],
    hours: "2.5h",
    rating: 5,
  },
  {
    date: "Feb 28, 2026",
    tech: "Anthony",
    tasks: ["Mounted TV in living room", "Smart thermostat install"],
    hours: "1.5h",
    rating: 5,
  },
  {
    date: "Feb 10, 2026",
    tech: "Anthony",
    tasks: ["Drywall patch (2 areas)", "Paint touch-up", "Door hinge tightening", "Curtain rod install"],
    hours: "3h",
    rating: 4,
  },
];
    ...
    <div className="min-h-screen bg-background pb-28">
      ...
      <div className="bg-surface border-b border-border px-5 pt-14 pb-5">
        ...
        <div className="mt-4 flex gap-2">
          {homeDetails.map(({ icon: Icon, label, value, color }) => (
      ...
      <div className="px-5 py-5 space-y-6">
        ...
        <div className="grid grid-cols-2 gap-3">
          ...
          <Card padding="sm" className="border border-border">
            ...
            <p className="text-[13px] font-semibold text-text-primary">{householdMembers.length} members</p>
            ...
            {householdMembers.map((member) => (
              <Card key={member.name} padding="sm" className="flex items-center gap-3">
                ...
                <a
                  ...
                  className="flex h-9 w-9 items-center justify-center rounded-full bg-success-light active:bg-success/20 transition-colors"
                >
          ...
          {showAddTask && (
            <Card padding="md" className="mb-3 border border-primary-100 bg-primary-50 animate-fade-in">
              ...
              <div className="flex gap-2">
                ...
                <Button variant="primary" size="sm" fullWidth disabled={!newTask.trim()} onClick={addTask}>
                  Add Task
                </Button>
              </div>
            </Card>
                    ...
                    <div className="flex-1 min-w-0">
                      <div className="flex items-start justify-between gap-2">
                        ...
                        <div className="flex items-center gap-1 shrink-0">
                          {item.specialist && (
                            <span className="rounded-full bg-[#FFF7ED] px-2 py-0.5 text-[10px] font-semibold text-accent-coral">
                              Specialist
                            </span>
                          )}
                          <ChevronRight
                      ...
                      {item.parts && (
                        <div className="mt-2.5 flex items-center gap-2 rounded-lg bg-surface-secondary px-3 py-2">
                          ...
                          <span className={`text-[10px] font-semibold shrink-0 ${
                            item.partStatus === "Purchased" ? "text-success" :
                            item.partStatus === "Tech to Purchase" ? "text-primary" :
                            "text-accent-amber"
                          }`}>
                            {item.partStatus}
            ...
            {completedVisits.map((visit) => {
              ...
              return (
                <Card
                  key={visit.date}
                  padding="sm"
                  onClick={() => setExpandedVisit(isExpanded ? null : visit.date)}
                  className="cursor-pointer"
                >
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <div className="flex items-center gap-2 mt-0.5">
                        <span className="text-[11px] text-text-tertiary">
                          {visit.tasks.length} tasks · {visit.hours}
                        </span>
                        <div className="flex items-center gap-0.5">
                          {Array.from({ length: 5 }).map((_, i) => (
                            <Star
                              key={i}
                              size={9}
                              className={i < visit.rating ? "fill-warning text-warning" : "fill-border text-border"}
                            />
                          ))}
                        </div>
                      </div>
                  ...
                  {isExpanded && (
                    <div className="mt-3 ml-13 space-y-1.5 pl-1 border-l-2 border-border ml-[52px]">
          ...
          <Card padding="md" className="space-y-4">
            <div className="flex items-start gap-3">
              ...
              <div className="flex-1">
                ...
                <p className="text-[12px] text-text-secondary mt-0.5 leading-relaxed">
                  Recommend replacement within 1–2 years. Risk of failure increases after 15 years.
                </p>
            ...
            <div className="flex items-start gap-3">
              ...
              <div className="flex-1">
                ...
                <p className="text-[12px] text-text-secondary mt-0.5 leading-relaxed">
                  Monitoring — may need specialist. Lubrication applied, check in 3 months.
                </p>
            ...
            <div className="flex items-start gap-3">
              ...
              <div className="flex-1">
                ...
                <p className="text-[12px] text-text-secondary mt-0.5 leading-relaxed">
                  Last replaced Feb 10. Recommend replacing every 90 days (Merv 11 or higher).
                </p>
                <p className="text-[10px] text-text-tertiary mt-1">Noted Mar 15, 2026 · Anthony</p>
              </div>
            </div>
